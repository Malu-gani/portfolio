...
I automated what repeats on every deploy and what a human doesn't catch at a glance: broken links, contrast, and visual regressions. The pipeline runs on GitHub Actions on every push and publishes the run's report.
