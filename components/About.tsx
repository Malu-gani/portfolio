...
export default function About({}: Props) {
  return (
    <motion.div
      ...
      className="flex flex-col relative h-screen text-center md:text-left md:flex-row maw-w-7x1 px-10 justify-evenly mx-auto items-center"
    >
      ...
      <motion.img
        ...
        className="-mb-20 md:mb-0 flex-srhink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[500px] xl:h-[600px]"
      />
